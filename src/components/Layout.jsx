...
export const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col">
      ...
      {/* MAIN CONTENT AREA */}
      <main className="flex-1 w-full px-5 py-8 animate-fade-in">
        {children || <Outlet />}
      </main>
        ...
        <div className="px-5 py-5">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-sm">
                <li><Link to="/" className="text-white hover:text-slate-200 transition">Home</Link></li>
                <li><Link to="/browse" className="text-white hover:text-slate-200 transition">Browse Models</Link></li>
                <li><Link to="/get-started" className="text-white hover:text-slate-200 transition">Get Started</Link></li>
                <li><Link to="/docs" className="text-white hover:text-slate-200 transition">Docs</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-white mb-2">About</h4>
              <p className="text-sm text-white mb-3">A platform for sharing and discovering mobile-optimized AI models for edge devices.</p>
              <a
                href="https://github.com/ahstewart/jacana-flutter"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-5 py-1.5 rounded-lg border border-slate-500 bg-slate-600 hover:bg-slate-500 text-white text-xs font-medium transition-all duration-200"
              >
          ...
          <div className="border-t border-slate-700 mt-5 pt-5 flex justify-between items-center">
            ...
            <div className="flex gap-6 text-sm">
              <a href="#" className="text-white hover:text-slate-200 transition">Privacy</a>
              <a href="#" className="text-white hover:text-slate-200 transition">Terms</a>
            </div>
          </div>
        </div>
      </footer>
